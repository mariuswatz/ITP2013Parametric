 ...
 * 
 * All code lifted from processing.core.PApplet, taken from 
 * the Processing 2.0.1 source on Github. 
 * https://github.com/processing/processing/
 * 
 * unlekker.data.ProcessingData contains convenience methods
 * to perform tasks like loadTable() and loadJSONArray() as
 * introduced in PApplet as part of Processing 2.0. To use it
 * simply initialize it with a reference to a PApplet object.
 * 
 * Not tested extensively, please report any issues at 
 * https://github.com/mariuswatz/teaching.
 * 
 */
...
public class ProcessingData {
  ...
  /*
   * Initialize with a reference to a PApplet instance
   * (i.e. your sketch.);
   * 
   * <code>ProcessingData dat=new ProcessingData(this);
   * dat.loadTable("yourdata.csv");
   * </code>
   */
